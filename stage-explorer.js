        ...
        this.stages = [
            {
                ...
                title: 'Carhuaz - Cordillera Negra - Carhuaz',
                route: 'Carhuaz - Cordillera Negra - Carhuaz',
                start: 'Carhuaz',
                finish: 'Carhuaz',
                distanceLabel: 'Circuito',
                climbLabel: '2,650 m',
                terrain: 'Ascenso de alta montaña con vistas al Huascarán',
                badge: 'Etapa de apertura',
                caption: 'Circuito rumbo a la Cordillera Negra.',
                description: 'Desde la Plaza de Carhuaz (2,650 m), ascenso exigente rumbo a la Cordillera Negra con espectaculares vistas al Huascarán.',
            ...
            },
            {
                number: '02',
                day: 'Jueves 13 mayo',
                title: 'Carhuaz - Chacas',
                route: 'Carhuaz - Chacas',
                start: 'Carhuaz',
                finish: 'Chacas',
                distanceLabel: '—',
                climbLabel: '2,000 m+',
                terrain: 'Carretera y asfalto hasta el túnel de la Punta Olímpica',
                badge: 'Techo del evento',
                caption: 'La cumbre del evento.',
                description: 'Etapa exigente hacia el túnel de la Punta Olímpica, con más de 2,000 m+ y llegada a la plaza de Chacas.',
            ...
            },
            {
                ...
                finish: 'Yanama',
                distanceLabel: '—',
                climbLabel: 'Pupash 4,050 m',
                terrain: 'Paso de Pupash y descenso técnico',
                badge: 'Conexión andina',
                caption: 'Alpamayo y cambio de ritmo.',
                description: 'Etapa corta pero impresionante: paso de Pupash (4,050 m), vista al nevado Alpamayo y descenso veloz a Yanama.',
            ...
            },
            {
                ...
                distanceLabel: '—',
                climbLabel: '1,500 m+',
                terrain: 'Etapa final con vista 360° y conquista de la meta',
                badge: 'Gran final',
                caption: 'La conquista de la meta.',
                description: 'Más de 1,500 m+ con paisajes inolvidables, vista 360° de la Cordillera Blanca y meta en Yungay.',
